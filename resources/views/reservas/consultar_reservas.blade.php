...
<div class="container col-sm-6 mt-3 mb-5">
    <div class="border rounded pt-4 px-5 pb-3 shadow">
        ...
        <h1 class="text-center mt-4 mb-4" style='color:green'>Reservas de clientes </h1>
         ...
         <div class='container mb-3'>
                 <div class='row'>
                     <div class='col-12'>
                         <div class='card'>
                             <div class='card-body'>
                                <p class='card-text fw-bold'>Nombre y Apellidos del cliente:   {{$fila->nombre}}  </p>
                                ...
                                <p class='card-title fw-bold'>Id de la reserva: {{$fila->id}}  </p>
