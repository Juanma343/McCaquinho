         ...
         <div class='container mb-3'>
                 <div class='row'>
                     <div class='col-12'>
                         <div class='card'>
                             <div class='card-body'>
                                <p class='card-title'>Reserva: {{$fila->id}}  </h5>
                                <p class='card-text'>Nombre:   {{$fila->nombre}}  </p>
                                <p class='card-text'>Teléfono:   {{$fila->telefono}}  </p>
                                <p class='card-subtitle mb-2 text-muted'>Fecha y hora de la reserva: {{$fila->timestamp}}  </h6>
                                <p class='card-text'>Número de comensales: {{$fila->num_comensales}}  </p>
                                <p class='card-text fw-bold'>Observaciones: {{$fila->observaciones}} </p>
                             </div>
                         </div>
                     </div>
                 </div>
