...
Route::post('/realizar_reserva', 'App\Http\Controllers\ReservasController@guardar')->name('guardarReserva');
...
Route::get('/mostrar_pedido', 'App\Http\Controllers\pedidoController@mostrar_pedido')->name('mostrar_pedido');
...
Route::get('/auth/sesion', 'App\Http\Controllers\loginController@verSesion')->name('sesion');
Route::post('/auth/auth/login', 'App\Http\Controllers\loginController@login' )->name('login');
